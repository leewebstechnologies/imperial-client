...
const Admission = () => {
  return (
    <main className={styles.admission}>
      ...
      <div className={styles.steps}>
        ...
        <div className={styles.step}>
          ...
          <p>
            We invite the child and parents for an informal interaction with the
            school staff.
          </p>
        </div>
        ...
        <div className={styles.step}>
          <h2>5. Fee Payment</h2>
          <p>
            Complete the fee payment to secure the seat and receive the welcome
            kit.
          </p>
        </div>
      </div>
